...
Scale255 <- function(input, output){
  ...
  if(missing(output)){
    stop("")}
  o_dir <- "/Users/lando/OTB/OTB-5.6.1-Darwin64/bin/otbcli_Rescale"
...
HaralickTextureExtration <- function(input, output){
  ...
  o_dir <- "/Users/lando/OTB/OTB-5.6.1-Darwin64/bin/otbcli_HaralickTextureExtraction"
...
BandSplit <- function(input, output){
  ...
  if(missing(output)){
    stop("")}
  o_dir <- "/Users/lando/OTB/OTB-5.6.1-Darwin64/bin/otbcli_SplitImage"
...
mergeBands <- function(layer.1, layer.2, out){
  ...
  if(missing(out)){
    stop("")}
  o_dir <- "/Users/lando/OTB/OTB-5.6.1-Darwin64/bin/otbcli_ConcatenateImages"
...
edge <- function(input, output){
  ...
  if(missing(output)){
    stop("Please provide output")}
  o_dir <- "/Users/lando/OTB/OTB-5.6.1-Darwin64/bin/otbcli_EdgeExtraction"
